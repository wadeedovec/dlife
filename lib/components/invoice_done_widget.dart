...
import 'invoice_done_model.dart';
export 'invoice_done_model.dart';
...
class InvoiceDoneWidget extends StatefulWidget {
  const InvoiceDoneWidget({
    super.key,
  ...
  @override
  State<InvoiceDoneWidget> createState() => _InvoiceDoneWidgetState();
}

class _InvoiceDoneWidgetState extends State<InvoiceDoneWidget> {
  late InvoiceDoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoiceDoneModel());
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          'hg8wcs22' /* Thank you for paying your invo... */,
                        ),
                        textAlign: TextAlign.center,
