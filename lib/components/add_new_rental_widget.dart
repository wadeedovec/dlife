...
import 'add_new_rental_model.dart';
export 'add_new_rental_model.dart';
...
class AddNewRentalWidget extends StatefulWidget {
  const AddNewRentalWidget({super.key});

  @override
  State<AddNewRentalWidget> createState() => _AddNewRentalWidgetState();
}

class _AddNewRentalWidgetState extends State<AddNewRentalWidget>
    with TickerProviderStateMixin {
  late AddNewRentalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewRentalModel());
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            FFLocalizations.of(context).getText(
                              '5sqpia42' /* Submit your rented property fo... */,
                            ),
                                    ...
                                    return FlutterFlowDropDown<String>(
                                      ...
                                      onChanged: (val) async {
                                        ...
                                        _model.selectedBlockRef =
                                            _model.blockRef?.reference;
                                        _model.selectedBlockId =
                                            _model.blockRef?.reference.id;
                                        safeSetState(() {});
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (selectedFiles != null) {
                                        ...
                                        try {
                                          ...
                                          _model.isDataUploading_uploadDataUmg =
                                              false;
                                        }
                                        if (selectedUploadedFiles.length ==
                                            ...
                                            downloadUrls.length ==
                                                selectedFiles.length) {
                                          safeSetState(() {
                                            _model.uploadedLocalFile_uploadDataUmg =
                                                selectedUploadedFiles.first;
                                            _model.uploadedFileUrl_uploadDataUmg =
                                                downloadUrls.first;
                                          });
                                        } else {
                                          safeSetState(() {});
                                    ...
                                    text: _model.isDataUploading_uploadDataUmg
                                        ? 'Uploaded'
                                        : 'Upload Document',
                                    icon: Icon(
                                    ...
                                    options: FFButtonOptions(
                                      ...
                                      elevation: 0.0,
                                      borderSide: BorderSide(
                                        color: _model.uploadedFileUrl_uploadDataUmg !=
                                                    ''
                                            ? FlutterFlowTheme.of(context)
                                                .success
                                            : Color(0x00000000),
                              ...
                              builder: (context) => FFButtonWidget(
                                onPressed: ((_model.textController.text == '') ||
                                    ...
                                    : () async {
                                        ...
                                        if (_model.uploadedFileUrl_uploadDataUmg !=
                                                '') {
                                ...
                                text: FFLocalizations.of(context).getText(
                                  '1g2blwr4' /* Submit for Verification */,
                                ),
                                options: FFButtonOptions(
                                  width: MediaQuery.sizeOf(context).width * 0.3,
                                  height:
