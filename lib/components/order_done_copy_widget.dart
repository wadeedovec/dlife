...
import 'order_done_copy_model.dart';
export 'order_done_copy_model.dart';
...
class OrderDoneCopyWidget extends StatefulWidget {
  const OrderDoneCopyWidget({
    super.key,
  ...
  @override
  State<OrderDoneCopyWidget> createState() => _OrderDoneCopyWidgetState();
}

class _OrderDoneCopyWidgetState extends State<OrderDoneCopyWidget> {
  late OrderDoneCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderDoneCopyModel());
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          '0yakeplx' /* Your order has been sent to th... */,
                        ),
                        textAlign: TextAlign.center,
                      ...
                      Text(
                        FFLocalizations.of(context).getText(
                          'wn58darj' /* Estimated preparation time: 15... */,
                        ),
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                              font: GoogleFonts.inter(
