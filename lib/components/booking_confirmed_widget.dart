...
class _BookingConfirmedWidgetState extends State<BookingConfirmedWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<SpaSubscriptionsRecord>(
      future: SpaSubscriptionsRecord.getDocumentOnce(widget.subRef!),
      builder: (context, snapshot) {
        ...
        final containerSpaSubscriptionsRecord = snapshot.data!;
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          FFLocalizations.of(context).getText(
                            'v56b2znx' /* Your spa appointment has been ... */,
                          ),
                          textAlign: TextAlign.center,
                          style: FlutterFlowTheme.of(context)
                              .headlineMedium
                        ...
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            if (containerSpaSubscriptionsRecord.type ==
                                'service')
                              FutureBuilder<SpaServicesRecord>(
                                future: SpaServicesRecord.getDocumentOnce(
                                    containerSpaSubscriptionsRecord
                                        .spaServiceId!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                                  if (!snapshot.hasData) {
                            ...
                            if (containerSpaSubscriptionsRecord.type ==
                                'package')
                              FutureBuilder<SpaPackagesRecord>(
                                future: SpaPackagesRecord.getDocumentOnce(
                                    containerSpaSubscriptionsRecord
                                        .spaPackageId!),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'cqo5g99g' /* A confirmation has been sent t... */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
