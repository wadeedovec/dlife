...
import 'new_property_done_model.dart';
export 'new_property_done_model.dart';
...
class NewPropertyDoneWidget extends StatefulWidget {
  const NewPropertyDoneWidget({
    super.key,
    String? type,
  }) : this.type = type ?? 'null';
  ...
  @override
  State<NewPropertyDoneWidget> createState() => _NewPropertyDoneWidgetState();
}

class _NewPropertyDoneWidgetState extends State<NewPropertyDoneWidget> {
  late NewPropertyDoneModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewPropertyDoneModel());
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'ppp1wqri' /* Request Submitted Successfully... */,
                    ),
                  ...
                  Column(
                    ...
                    children: [
                      Text(
                        FFLocalizations.of(context).getText(
                          '1dv9mfbc' /* We've received your request an... */,
                        ),
                        textAlign: TextAlign.center,
                      ...
                      if (widget.type == 'tenant') {
                        return Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed(RentalWidget.routeName);
                            },
                            text: FFLocalizations.of(context).getText(
                              'g9wmoixw' /* Go to Rental */,
                            ),
                            icon: Icon(
                              Icons.home_outlined,
                              size: 18.0,
