...
import '/components/gym_thank_you_widget.dart';
...
import 'gym_subscription_checkout_model.dart';
export 'gym_subscription_checkout_model.dart';
...
class GymSubscriptionCheckoutWidget extends StatefulWidget {
  const GymSubscriptionCheckoutWidget({
    super.key,
  ...
  @override
  State<GymSubscriptionCheckoutWidget> createState() =>
      _GymSubscriptionCheckoutWidgetState();
}

class _GymSubscriptionCheckoutWidgetState
    extends State<GymSubscriptionCheckoutWidget> with TickerProviderStateMixin {
  late GymSubscriptionCheckoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GymSubscriptionCheckoutModel());
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        ...
        child: FutureBuilder<GymPackagesRecord>(
          future: GymPackagesRecord.getDocumentOnce(widget.packageID!),
          builder: (context, snapshot) {
            ...
            final containerGymPackagesRecord = snapshot.data!;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            's3e84w3z' /* Choose when you want to start ... */,
                          ),
                          textAlign: TextAlign.start,
                          style: FlutterFlowTheme.of(context)
                              .headlineSmall
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                containerGymPackagesRecord.name
                                                    .maybeHandleOverflow(
                                                  maxChars: 25,
                                                  replacement: '…',
                                                ),
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  dateTimeFormat(
                                                    "d/M/y",
                                                    functions
                                                        .calculateGymEndDateFormatted(
                                                            _model.datePicked!,
                                                            containerGymPackagesRecord
                                                                .totalMonths),
                                                    locale: FFLocalizations.of(
                                                            context)
                                                        .languageCode,
                              ...
                              if (valueOrDefault(
                                ...
                                return Row(
                                  ...
                                  children: [
                                    Text(
                                      formatNumber(
                                        containerGymPackagesRecord.price,
                                  ...
                                  if (_model.datePicked != null) {
                                    ...
                                    if (_model.walletInfo!.walletAmount >=
                                        (valueOrDefault(
                                            ...
                                            : containerGymPackagesRecord
                                                .price)) {
                                      await GymSubscriptionsRecord.collection
                                          .doc()
                                          .set({
                                        ...createGymSubscriptionsRecordData(
