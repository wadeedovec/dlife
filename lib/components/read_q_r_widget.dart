...
import 'read_q_r_model.dart';
export 'read_q_r_model.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      'ifo7q0bs' /* Scan this code to receive paym... */,
                    ),
                      ...
                      child: Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              context
                                  .pushNamed(QrCodeGeneratorWidget.routeName);
                            },
                            child: Container(
                              width: 150.0,
                              height: 150.0,
                              child: custom_widgets.KaiQRCodeRenderWidgetCopy(
                                width: 150.0,
                                height: 150.0,
                                data: currentUserUid,
                                cornersColor:
                ...
                Padding(
                  ...
                  child: Text(
                    FFLocalizations.of(context).getText(
                      '7801xfep' /* This QR code is linked to your... */,
                    ),
