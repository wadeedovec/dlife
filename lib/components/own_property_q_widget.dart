...
import '/components/rented_property_q_widget.dart';
...
import 'own_property_q_model.dart';
export 'own_property_q_model.dart';
...
class OwnPropertyQWidget extends StatefulWidget {
  const OwnPropertyQWidget({super.key});

  @override
  State<OwnPropertyQWidget> createState() => _OwnPropertyQWidgetState();
}

class _OwnPropertyQWidgetState extends State<OwnPropertyQWidget> {
  late OwnPropertyQModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OwnPropertyQModel());
                  ...
                  children: [
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        '2iz4lu6p' /* Do you own a property? */,
                      ),
                    ...
                    Text(
                      FFLocalizations.of(context).getText(
                        'qgsgo91w' /* Do you own any property with D... */,
                      ),
                      textAlign: TextAlign.center,
