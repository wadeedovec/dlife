...
class InvoiceDetailsWidget extends StatefulWidget {
  ...
  final DocumentReference? invoiceID;

  static String routeName = 'invoiceDetails';
  static String routePath = '/invoiceDetails';
...
class _InvoiceDetailsWidgetState extends State<InvoiceDetailsWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<InvoicesRecord>(
      future: InvoicesRecord.getDocumentOnce(widget.invoiceID!),
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: Builder(
                                                      builder: (context) {
                                                        if (invoiceDetailsInvoicesRecord
                                                                .status ==
                                                            'overdue') {
                                                          return Container(
                                                            width: 90.0,
                                                        ...
                                                        } else if (invoiceDetailsInvoicesRecord
                                                                .status ==
                                                            'unpaid') {
                                                          return Container(
                                                            width: 90.0,
                                                  ...
                                                  children: [
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        '7sdqzzqf' /* Common Area Utilities: */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                  ...
                                  if (invoiceDetailsInvoicesRecord.status !=
                                      'paid')
                                    Builder(
