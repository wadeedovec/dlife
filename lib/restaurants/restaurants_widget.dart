                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'ceurhbv2' /* Choose Your Restaurant */,
                                    ),
                                  ...
                                  Align(
                                    alignment: AlignmentDirectional(0.9, -1.1),
                                    child: Container(
                                                          ...
                                                          children: [
                                                            Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'wzkjv9e3' /* Mediterranean & Turkish • $$$ */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: Text(
                                                                      FFLocalizations.of(
                                                                              context)
                                                                          .getText(
                                                                        '8ar0qoxv' /* Mediterranean Cuisine */,
                                                                      ),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
